    ...
    return (
        <LayoutContentWrapper style={{ height: '150vh' }}>
            <LayoutContent>
                ...
                <PageHeader>
                    {<IntlMessages id="forms.addUserForm.header" />}
                </PageHeader>
                <Box style={{ height: '90%' }}>
                    <Form>
                        <FormItem
                            ...
                            help={
                                registrationError === ErrorTypeEnums.MaxSizeError ? <IntlMessages id="forms.maxSizeError" /> :
                                    registrationError === ErrorTypeEnums.MinSizeError ? <IntlMessages id="forms.minSizeError" /> :
                                        registrationError === ErrorTypeEnums.RequiredError ? <IntlMessages id="forms.requiredError" /> :
                                            registrationError === ErrorTypeEnums.RegexError ? <IntlMessages id="forms.regexError" /> : null}
                        >
                        ...
                        <FormItem
                            ...
                            help={
                                nameError === ErrorTypeEnums.MaxSizeError ? <IntlMessages id="forms.maxSizeError" /> :
                                    nameError === ErrorTypeEnums.MinSizeError ? <IntlMessages id="forms.minSizeError" /> :
                                        nameError === ErrorTypeEnums.RequiredError ? <IntlMessages id="forms.requiredError" /> :
                                            nameError === ErrorTypeEnums.RegexError ? <IntlMessages id="forms.regexError" /> : null}
                        >
                        ...
                        <FormItem
                            ...
                            help={
                                mailError === ErrorTypeEnums.MaxSizeError ? <IntlMessages id="forms.maxSizeError" /> :
                                    mailError === ErrorTypeEnums.MinSizeError ? <IntlMessages id="forms.minSizeError" /> :
                                        mailError === ErrorTypeEnums.RequiredError ? <IntlMessages id="forms.requiredError" /> :
                                            mailError === ErrorTypeEnums.RegexError ? <IntlMessages id="forms.regexError" /> : null}
                        >
                        ...
                        <FormItem
                            ...
                            help={
                                cellPhoneError === ErrorTypeEnums.MaxSizeError ? <IntlMessages id="forms.maxSizeError" /> :
                                    cellPhoneError === ErrorTypeEnums.MinSizeError ? <IntlMessages id="forms.minSizeError" /> :
                                        cellPhoneError === ErrorTypeEnums.RequiredError ? <IntlMessages id="forms.requiredError" /> :
                                            cellPhoneError === ErrorTypeEnums.RegexError ? <IntlMessages id="forms.regexError" /> : null}
                        >
